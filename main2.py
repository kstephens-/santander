...
#train.insert(1, 'PCAFour', x_train_projected[:, 3])
#train.insert(1, 'PCAFive', x_train_projected[:, 4])
#train.insert(1, 'PCASix', x_train_projected[:, 5])
...
#test.insert(1, 'PCAFour', x_test_projected[:, 3])
#test.insert(1, 'PCAFive', x_test_projected[:, 4])
#test.insert(1, 'PCASix', x_test_projected[:, 5])
